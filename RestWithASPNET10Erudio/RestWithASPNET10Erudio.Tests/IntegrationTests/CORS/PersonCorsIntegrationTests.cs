...
namespace RestWithASPNET10Erudio.Tests.IntegrationTests.CORS
{
    ...
    public class PersonCorsIntegrationTests : IClassFixture<SqlServerFixture>
    {
        ...
        [TestPriority(1)]
        public async Task CreatePerson_WithAllowedOrigin_ShouldReturnCreate()
        {
            //Arrange
        ...
        {
            //Arrange
            AddOriginHeader("http://semeru.com.br");
        ...
        public async Task FindPersonById_WithAllowedOrigin_ShouldReturnOk()
        {
            ...
            found.FirstName.Should().Be("Dimas");
            found.LastName.Should().Be("Dog");
            found.Address.Should().Be("BC");
            found.Gender.Should().Be("Male");
